	...
	<mounting-portal mount-to="#woowgallery-portal" name="woowgallery-bulk-edit-items" v-if="bulkEdit" v-cloak append>
		<template>
			<div tabindex="0" class="upload-php media-modal wp-core-ui woowgallery-bulk-edit-modal">
				<button @click.prevent="bulkEditClose()" type="button" class="media-modal-close"><span class="media-modal-icon"><span class="screen-reader-text"><?php esc_html_e( 'Close media panel', 'wgtd' ); ?></span></span></button>
				<div class="media-modal-content">
					<div class="edit-attachment-frame mode-select hide-menu hide-router">
						<div class="media-frame-title">
							<h1><?php esc_html_e( 'Bulk Edit Items Data', 'wgtd' ); ?></h1>
						</div>
								...
								<div class="attachment-info">
									...
									<div class="settings">
										...
										<div class="woowgallery-setting">
											...
											<div class="description"><?php esc_html_e( 'Controls whether this individual item is Private or Published within the Gallery.', 'wgtd' ); ?></div>
										</div>
											...
											<div class="wg-clearfix">
												<label class="switcher"><?php esc_html_e( 'Source:', 'wgtd' ); ?>
													<select id="item-title-src" v-model="bulkEdit.title_src">
														<option value=""><?php esc_html_e( 'Do not change', 'wgtd' ); ?></option>
														<option value="title" v-text="('post' === bulkEditType)? '<?php echo esc_js( __( 'Post Title', 'wgtd' ) ); ?>' : '<?php echo esc_js( __( 'Media Title', 'wgtd' ) ); ?>'"></option>
										...
										<div class="woowgallery-setting">
											<div class="woowgallery-flex space-between">
												...
												<div class="buttons textright" v-if="'attachment' === bulkEditType">
													<button v-if="bulkEdit.link.url_change" class="button button-small choose-link" data-woowgallery-custom-link="item-link-url"><?php esc_html_e( 'Choose Link', 'wgtd' ); ?></button>
												</div>
											</div>
											...
											<template v-if="'attachment' === bulkEditType">
												...
												<div class="description"><?php esc_html_e( 'Enter a hyperlink if you wish to link each of these items to somewhere other than its original file.', 'wgtd' ); ?></div>
											</template>
											...
											<div class="tagsdiv" :id="bulkEditTagsTaxonomy()">
												<div class="jaxtag">
													...
													<div class="description">
														<?php esc_html_e( 'Enter a comma separated list of Tags that you want to be added to these items.', 'wgtd' ); ?><br/>
														<template v-if="bulkEditTagsTaxonomy(true)">
															<?php esc_html_e( 'Note: tags will be applied for these items in all galleries.', 'wgtd' ); ?>
														</template>
													</div>
												</div>
									...
									<div class="actions">
										...
										<button @click="bulkEditSave()" class="button button-primary woowgallery-bulk-save"><?php esc_html_e( 'Save Changes', 'wgtd' ); ?></button>
									</div>
									<!-- /.actions -->
								</div>
							</div>
