...
<div class="woowgallery-code">
	...
	<a href="#" title="<?php esc_attr_e( 'Copy Shortcode to Clipboard', 'wgtd' ); ?>" data-clipboard-target="#woowgallery_shortcode_id_<?php echo absint( $data['post']->ID ); ?>" class="dashicons dashicons-clipboard woowgallery-clipboard">
		<span><?php esc_html_e( 'Copy to Clipboard', 'wgtd' ); ?></span>
	</a>
</div>
...
<div class="woowgallery-code">
	...
	<a href="#" title="<?php esc_attr_e( 'Copy Shortcode to Clipboard', 'wgtd' ); ?>" data-clipboard-target="#woowgallery_shortcode_slug_<?php echo absint( $data['post']->ID ); ?>" class="dashicons dashicons-clipboard woowgallery-clipboard">
		<span><?php esc_html_e( 'Copy to Clipboard', 'wgtd' ); ?></span>
	</a>
</div>
...
<div class="woowgallery-code">
	...
	<a href="#" title="<?php esc_attr_e( 'Copy Template Tag to Clipboard', 'wgtd' ); ?>" data-clipboard-target="#woowgallery_template_tag_slug_<?php echo absint( $data['post']->ID ); ?>" class="dashicons dashicons-clipboard woowgallery-clipboard">
		<span><?php esc_html_e( 'Copy to Clipboard', 'wgtd' ); ?></span>
	</a>
</div>
